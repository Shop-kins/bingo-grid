...
class SheetsClient(
    ...
    fun getColumnData(column: String, sheet: String = "EasyHard"): SheetsData{
        val fullUrl = sheetsUrl + "$sheet!${column}2:$column?key=AIzaSyBZ306luTw34m-8uRMCE4rQYPU9CVgAXTY"
